  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
      ...
      <button
        ...
        className="mt-2 h-11 w-full rounded-lg bg-[var(--color-interactive)] text-sm font-medium text-white transition-colors hover:bg-[var(--color-interactive)]/90 focus:outline-none focus:ring-2 focus:ring-[var(--color-interactive)]/30 disabled:cursor-not-allowed disabled:opacity-50"
      >

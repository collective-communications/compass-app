    ...
    >
      ...
      {isReady && report.storagePath !== null && (
        <button
          ...
          className="mt-2 flex items-center justify-center gap-2 rounded-md bg-[var(--color-interactive)] px-4 py-2.5 text-sm font-medium text-white transition-colors hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[var(--color-interactive)] focus:ring-offset-2 disabled:opacity-50"
        >
          {isDownloading ? (

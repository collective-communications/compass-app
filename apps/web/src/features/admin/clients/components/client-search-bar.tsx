    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-[var(--grey-100)] bg-[var(--grey-50)] px-4 py-2 text-sm text-[var(--grey-900)] placeholder:text-[var(--grey-400)] focus:border-[var(--color-core)] focus:outline-none focus:ring-1 focus:ring-[var(--color-core)] sm:w-64"
        />
      </div>

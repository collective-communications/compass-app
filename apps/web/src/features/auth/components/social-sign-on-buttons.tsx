...
export function SocialSignOnButtons({ onSignIn, isLoading }: SocialSignOnButtonsProps): React.ReactElement {
  const buttonClasses =
    'flex w-full items-center justify-center gap-3 rounded-lg border border-[var(--grey-300)] bg-white px-4 py-2.5 text-sm font-medium text-[var(--grey-700)] transition-colors hover:bg-[var(--grey-50)] focus:outline-none focus:ring-2 focus:ring-[var(--color-core)]/20 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50';

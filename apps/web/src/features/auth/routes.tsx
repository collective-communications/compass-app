 ...
 * Creates the `/auth` route tree for login, callback, and password reset.
 */
...
export function createAuthRoutes<TParent extends AnyRoute>(parentRoute: TParent) {
  ...
  return authRoute.addChildren([loginRoute, callbackRoute, forgotPasswordSentRoute, forgotPasswordRoute]);
}

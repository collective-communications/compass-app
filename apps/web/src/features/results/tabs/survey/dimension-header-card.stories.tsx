...
const coreQuestions: QuestionScoreRow[] = [
  { questionId: 'q1', questionText: 'I feel safe to speak up at work.', dimensionCode: 'core', meanScore: 0.82, distribution: { 1: 3, 2: 8, 3: 40, 4: 49 }, responseCount: 142, isReverseScored: false },
...
export const Clarity: Story = {
  args: {
    ...
    color: '#FF7F50',
    questions: [
      { questionId: 'q4', questionText: 'I understand how my work contributes to organizational goals.', dimensionCode: 'clarity', meanScore: 0.7, distribution: { 1: 10, 2: 18, 3: 38, 4: 34 }, responseCount: 142, isReverseScored: false },
      { questionId: 'q5', questionText: 'Expectations for my role are clearly defined.', dimensionCode: 'clarity', meanScore: 0.66, distribution: { 1: 12, 2: 20, 3: 36, 4: 32 }, responseCount: 142, isReverseScored: false },
    ],
  },
};
...
export const SingleQuestion: Story = {
  args: {
    ...
    color: '#9FD7C3',
    questions: [
      { questionId: 'q6', questionText: 'I feel a sense of belonging at work.', dimensionCode: 'connection', meanScore: 0.54, distribution: { 1: 20, 2: 25, 3: 30, 4: 25 }, responseCount: 142, isReverseScored: false },
    ],
  },
};

  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-full rounded-lg border border-[var(--grey-100)] bg-[var(--grey-50)] px-4 py-2 pr-10 text-sm text-[var(--grey-900)] placeholder:text-[var(--text-placeholder)] focus:border-[var(--grey-700)] focus:outline-none"
      />
      {localValue.length > 0 && (
        <button
          type="button"
